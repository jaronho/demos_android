...
public class StockBarDataSet extends BarLineScatterCandleBubbleDataSet<BarEntry> implements IBarDataSet {
    ...
    public StockBarDataSet(List<BarEntry> yVals, String label) {
        super(yVals, label);
    ...
    public DataSet<BarEntry> copy() {
        ...
        StockBarDataSet copied = new StockBarDataSet(yVals, getLabel());
    ...
    public int getColor(int index) {
        float[] fs = getEntryForXIndex(index).getVals();
        int fh = (fs[2] - fs[1]) > 0 ? 0 : 1;
        return super.getColor(fh);
    }
}
