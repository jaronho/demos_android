...
//            Log.e("LineChartRenderer", "color size > 1");
...
//                    Log.e("LineChartRenderer", e1.toString() + "  " + e2.toString());

                    if (e1 == null || e2 == null)
                        continue;

//                    if (e1.getVal() == Float.NaN || e2.getVal() == Float.NaN)
//                        continue;
                ...
                if (j > 0) {
//                    Log.e("LineChartRenderer", "j > 0");

//                    for (int xx = 0, size = mLineBuffer.length; xx < size; xx++) {
//                        Log.e("LineChartRenderer", xx + "    " + mLineBuffer[xx] + "");
//                    }
...
//        mRenderPaint.setPathEffect(null);
    ...
    protected void drawCircles(Canvas c) {
        ...
        for (int i = 0; i < dataSets.size(); i++) {
            ...
            boolean drawFirstCircleHole = dataSet.ismDrawFirstCircleHole();
            ...
            for (int j = minx,
                ...
                if (drawTransparentCircleHole) {
                    ...
                    // draw first point circle if promise
                    if ((j + 1) == count && drawFirstCircleHole) {
                        c.drawCircle(circlesBuffer[0], circlesBuffer[1],
                                dataSet.getFirstCircleRadius() * 2,
                                mRenderPaint);
                    }
    ...
    private static class PlayHandler extends Handler {
        ...
        WeakReference<Float> fx, fy, radius;
        WeakReference<Paint> paint;
        ...
        public void setFx(float fx) {
            this.fx = new WeakReference<Float>(fx);
        }

        public void setFy(float fy) {
            this.fy = new WeakReference<Float>(fy);
        }

        public void setRadius(float radius) {
            this.radius = new WeakReference<Float>(radius);
        }

        public void setPaint(Paint paint) {
            this.paint = new WeakReference<Paint>(paint);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            mCanvas = this.mCanvas.get();
            fx = this.fx.get();
            fy = this.fy.get();
            radius = this.radius.get();
            paint = this.paint.get();
        }
    }
