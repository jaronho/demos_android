...
# in D:\Android\AndroidStudio-143.2821654\sdk1/tools/proguard/proguard-android.txt
...
#---------------------------------实体类---------------------------------
#修改成你对应的包名
-keep class com.example.classes.** { *; }

#---------------------------------第三方包-------------------------------
-keep class ASimpleCache.org.afinal.simplecache{*;}
...
#下面中括号的地方需要要填你的包名
-keep public class com.example.nyapp.R$*{
