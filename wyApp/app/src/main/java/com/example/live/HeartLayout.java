...
public class HeartLayout extends RelativeLayout implements View.OnClickListener {
    private HeartPathAnimator mAnimator;
    ...
    private void findViewById(Context context) {
        LayoutInflater.from(context).inflate(R.layout.live_layout_periscope, this);
        bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.live_icon_like_png);
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        final TypedArray a = getContext().obtainStyledAttributes(
                attrs, R.styleable.live_heart_layout, defStyleAttr, 0);
        ...
        mAnimator = new HeartPathAnimator(HeartPathAnimator.Config.fromTypeArray(a, initX, textHight, pointx, dWidth, dHeight));
        a.recycle();
    }
    ...
    public HeartPathAnimator getAnimator() {
        return mAnimator;
    }

    public void setAnimator(HeartPathAnimator animator) {
        clearAnimation();
        mAnimator = animator;
    }
    ...
    private static int[] drawableIds = new int[]{R.drawable.live_heart0, R.drawable.live_heart1, R.drawable.live_heart2, R.drawable.live_heart3, R.drawable.live_heart4, R.drawable.live_heart5, R.drawable.live_heart6, R.drawable.live_heart7, R.drawable.live_heart8,};
