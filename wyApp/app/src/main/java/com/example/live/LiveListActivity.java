...
public class LiveListActivity extends AppCompatActivity {
    ...
    private ListFragment mLiveListFragment = null;
    private ListFragment mVideoListFragment = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLiveListFragment = ListFragment.create(ListFragment.TYPE_LIVE);
        mVideoListFragment = ListFragment.create(ListFragment.TYPE_VIDEO);
        List<Fragment> fragments = new ArrayList<>();
        fragments.add(mLiveListFragment);
    ...
    void switchTabLive() {
        ...
        mLiveListFragment.setCanInitList();
    }
    ...
    void switchTabViedo() {
        ...
        mVideoListFragment.setCanInitList();
    }
}
