...
public class MyLiveListActivity extends AppCompatActivity {
    ...
    private ListFragment mMyJoinListFragment = null;
    private ListFragment mMyCollectListFragment = null;
    private ListFragment mMyStartListFragment = null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.live_my_list_activity);
        ...
        mMyJoinListFragment = ListFragment.create(ListFragment.TYPE_MY_JOIN);
        mMyCollectListFragment = ListFragment.create(ListFragment.TYPE_MY_COLLECT);
        mMyStartListFragment = ListFragment.create(ListFragment.TYPE_MY_START);
        List<Fragment> fragments = new ArrayList<>();
        fragments.add(mMyJoinListFragment);
        fragments.add(mMyCollectListFragment);
        fragments.add(mMyStartListFragment);
    ...
    void switchTabJoin() {
        ...
        mMyJoinListFragment.setCanInitList();
    }
    ...
    void switchTabCollect() {
        ...
        mMyCollectListFragment.setCanInitList();
    }
    ...
    void switchTabStart() {
        ...
        mMyStartListFragment.setCanInitList();
    }
}
