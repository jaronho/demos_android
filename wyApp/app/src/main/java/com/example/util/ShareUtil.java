...
public class ShareUtil {
    ...
    private static ShareListener mListener = null;
    ...
    public static void initShareDate(Activity activity, Share.DataBean mShareData, ShareListener listener) {
        mListener = listener;
        initShareDate(activity, mShareData);
    }
}
