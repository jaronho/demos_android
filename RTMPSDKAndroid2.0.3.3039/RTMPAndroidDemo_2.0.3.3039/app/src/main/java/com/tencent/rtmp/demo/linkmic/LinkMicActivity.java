package com.tencent.rtmp.demo.linkmic;
    ...
    protected void onCreateView() {
        ...
        mBtnPushType.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mVideoPublish) {
                    mLivePusher.setVideoQuality(mMainPublish ? TXLiveConstants.VIDEO_QUALITY_LINKMIC_MAIN_PUBLISHER : TXLiveConstants.VIDEO_QUALITY_LINKMIC_SUB_PUBLISHER);
                }
            }
        });
    ...
    protected void initUrlScanLayout() {
        ...
        strNoticeText.setSpan(new ClickableSpan() {
            ...
            public void onClick(View widget) {
                Uri uri = Uri.parse("https://www.qcloud.com/document/product/454/8872");
