...
import com.gsclub.strategy.contract.home.PersonalRecord5DYieldContract;
...
public class PersonalRecord5DYieldPresenter extends RxPresenter<PersonalRecord5DYieldContract.View> implements PersonalRecord5DYieldContract.Presenter {

    private DataManager mDataManager;

    @Inject
    public PersonalRecord5DYieldPresenter(DataManager mDataManager) {
