...
import com.gsclub.strategy.di.cookie.PersistentCookieStore;
import com.gsclub.strategy.di.qualifier.StrategyUrl;
import com.gsclub.strategy.http.CustomConverterFactory;
...
//                            System.out.println("gsclub request => " + url + "  " + message + "\n");
...
//                            System.out.println("gsclub response=> " + newResPonse + "\n");
//                        } else {
//                            System.out.println("gsclub => " + message + "\n");
//                        }
