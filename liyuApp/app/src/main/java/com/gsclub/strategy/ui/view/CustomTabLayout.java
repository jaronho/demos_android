...
public class CustomTabLayout extends HorizontalScrollView {
    ...
    private void addTabView(Tab tab) {
        ...
        //在此处添加绘制下划线的相关值
        mTabStrip.setDrawLineWidth(tabView.getTextView().getMeasuredWidth());
        mTabStrip.setSelectedIndicatoRelongateWidth(0);//10
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        private int mSelectedIndicatoRelongateWidth;
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                ...
                int margin = ((width - drawLineWidth) / 2) - mSelectedIndicatoRelongateWidth;
                canvas.drawRect(mIndicatorLeft + margin, getHeight() - mSelectedIndicatorHeight,
                        mIndicatorRight - margin, getHeight(), mSelectedIndicatorPaint);
            }
        }
        ...
        public void setSelectedIndicatoRelongateWidth(int mSelectedIndicatoRelongateWidth) {
            this.mSelectedIndicatoRelongateWidth = mSelectedIndicatoRelongateWidth;
        }
    }
    ...
    public final class TabItem extends View {
        ...
        public TabItem(Context context, AttributeSet attrs) {
            ...
            // TODO: 2018/10/8 修改tablayout的item
...
//            mIcon = a.getDrawable(android.support.design.R.styleable.TabItem_android_icon);
            mIcon = getContext().getResources().getDrawable(R.drawable.bg_tablayout_bottom_line);
