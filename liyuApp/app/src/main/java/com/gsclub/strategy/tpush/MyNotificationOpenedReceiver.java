...
public class MyNotificationOpenedReceiver extends BroadcastReceiver {
    public static final String ACTION_NOTIFICATION_OPEN = "com.gsclub.strategy.android.intent.NOTIFICATION_OPENED";
    public static final String ACTION_NOTIFICATION_CLICKED_RESULT = "com.gsclub.strategy.android.intent.NOTIFICATION_CLICKED_RESULT";
    public static final String ACTION_NOTIFICATION_CLICKED_RESULT_RESTART = "com.gsclub.strategy.android.intent.NOTIFICATION_CLICKED_RESULT_RESTART";
    public static final String ACTION_SPLASH_STARTED = "com.gsclub.strategy.android.intent.SPLASH_STARTED";
