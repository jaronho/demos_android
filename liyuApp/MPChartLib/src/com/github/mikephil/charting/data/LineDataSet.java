...
public class LineDataSet extends LineRadarDataSet<Entry> implements ILineDataSet {
    ...
    private float mFirstCircleRadius = 8f;
    ...
    /**
     * if true, drawing the first point circles is enabled
     */
    private boolean mDrawFirstCircleHole = false;
    ...
    public DataSet<Entry> copy() {
        ...
        copied.mFirstCircleRadius = mFirstCircleRadius;
        ...
        copied.mDrawFirstCircleHole = mDrawFirstCircleHole;
    ...
    @Override
    public float getFirstCircleRadius() {
        return mFirstCircleRadius;
    }

    public void setFirstCircleRadius(float mFirstCircleRadius) {
        this.mFirstCircleRadius = Utils.convertDpToPixel(mFirstCircleRadius);
    }
    ...
    @Override
    public boolean ismDrawFirstCircleHole() {
        return mDrawFirstCircleHole;
    }

    public void setmDrawFirstCircleHole(boolean mDrawFirstCircleHole) {
        this.mDrawFirstCircleHole = mDrawFirstCircleHole;
    }
